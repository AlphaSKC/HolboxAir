    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:title" content="My Trips | Holbox Air" />
                <meta property="og:description" content="Manage your trips and reservations with Holbox Air." />
                ...
                <meta property="og:url" content="https://holboxair.com/my-trips" />
